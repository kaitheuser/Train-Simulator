classdef arduino < handle
    ...
    % Modified by Mike Vernier @ Ohio State for use with the custom OSU FETSS motor controller
    % can still be used with the adafruit motor controller (detects the board differences) 
    ...
    properties (Hidden=true)
        ...
        servorange = 2:69; % Range of servo pin numbers. Train Set requires 0:1 rest 2:69
    end
    ...
    methods
        ...
        function a=arduino(comPort)
            ...
            elseif chk==4,
                disp('FE Train Set Shield Script detected !' );
                a.servorange = 1:2;
            else
                delete(a);
            ...
            if isvalid(a),
                if isa(a.aser,'serial') && isvalid(a.aser),
                    ...
                    if a.mots==2,
                        ...
                        disp(' ');
                        disp('Serial port Methods: <a href="matlab:help serial">serial</a> <a href="matlab:help flush">flush</a>');
                    elseif a.mots==1,
        ...
        function servoAttach(a,pin)
            ...
            % than the Mega, use of the servos disables analogWrite() functionality
            ...
            if a.chkp,
                ...
                % check pin
                errstr=arduino.checknum(pin,'servo number',a.servorange);
                if ~isempty(errstr), error(errstr); end
        ...
        function val=servoRead(a,pin)
            ...
            if a.chkp,
                ...
                % check status
                if a.srvs(pin)~=1,
                    error(['Servo ' num2str(pin) ' is not attached, please use a.servoAttach(' num2str(pin) ') to attach it']);
                end
